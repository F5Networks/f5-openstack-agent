...
from f5_openstack_agent.tests.tempest.services.clients import bigip_client
from f5_openstack_agent.tests.tempest.services.clients import \
    health_monitors_client
from f5_openstack_agent.tests.tempest.services.clients import listeners_client
from f5_openstack_agent.tests.tempest.services.clients import \
    load_balancers_client
from f5_openstack_agent.tests.tempest.services.clients import members_client
from f5_openstack_agent.tests.tempest.services.clients import pools_client
...
def _setup_bigip_args():
    bigip_hostname = CONF.icontrol.icontrol_hostname
    bigip_username = CONF.icontrol.icontrol_username
    bigip_password = CONF.icontrol.icontrol_password
    
    return (bigip_hostname, bigip_username, bigip_password)
...
class BaseTestCase(base.BaseNetworkTest):
    ...
    def resource_setup(cls):
        ...
        cls.bigip_client = bigip_client.BigIPClient(*bigip_args)
