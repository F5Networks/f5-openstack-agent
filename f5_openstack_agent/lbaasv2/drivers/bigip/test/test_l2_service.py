...
def service():
    return {
        ...
        'members': [{'address': '10.2.2.3',
                      ...
                      'tenant_id': 'd9ed216f67f04a84bf8fd97c155855cd',
                      'port': {'mac_address': 'fa:16:3e:0d:fa:c8'},
                      'vxlan_vteps': ['192.168.130.59'],
                      'weight': 1},
                     {'address': '10.2.2.4',
                      'admin_state_up': True,
                      'id': '1e7bfa17-a38f-4728-a3a7-aad85da69714',
                      'name': '',
                      'network_id': 'cdf1eb6d-9b17-424a-a054-778f3d3a5490',
                      'operating_status': 'ONLINE',
                      'pool_id': '2dbca6cd-30d8-4013-9c9a-df0850fabf52',
                      ...
                      'subnet_id': '81f42a8a-fc98-4281-8de4-2b946e931457',
                      'tenant_id': 'd9ed216f67f04a84bf8fd97c155855cd',
                      'port':  {'mac_address': 'fa:16:3e:0d:fa:c6'},
                      'vxlan_vteps': ['192.168.130.60'],
                      'weight': 1}],
        'networks': {
        ...
        'pools': [{'admin_state_up': True,
                    ...
                    'name': '',
                    'operating_status': 'ONLINE',
                    'partition': 'Test_d9ed216f67f04a84bf8fd97c155855cd',
                    'protocol': 'HTTP',
                    'provisioning_status': 'ACTIVE',
