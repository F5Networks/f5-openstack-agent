...
def service():
    return {
        "listeners": [{
            "admin_state_up": True,
            "connection_limit": -1,
            "default_pool_id": "2dbca6cd-30d8-4013-9c9a-df0850fabf52",
            "default_tls_container_id": None,
            "description": "",
            "id": "5108c2fe-29bd-4e5b-94de-99034c561a15",
            "l7_policies": [],
            "loadbalancer_id": "75e9326d-67ec-42b7-9647-3fc1c51c0091",
            "name": "listener2",
            "operating_status": "ONLINE",
            "protocol": "HTTPS",
            "protocol_port": 443,
        ...
        "healthmonitors": [{
            "admin_state_up": True,
            "id": "5108c2fe-29bd-4e5b-94de-aaaaaaaaa",
            "provisioning_status": "ACTIVE",
            "tenant_id": "980e3f914f3e40359c3c2d9470fb2e8a"
        }],
        'networks': {
        ...
        'loadbalancer': {
            'admin_state_up': True,
            'description': '',
            'gre_vteps': ['201.0.162.1',
                           '201.0.160.1',
                           '201.0.165.1'],
            'id': 'd5a0396e-e862-4cbf-8eb9-25c7fbc4d593',
            'listeners': [
                {'id': 'e3af03f4-d3df-4c9b-b3dd-8002f133d5bf'}],
            'name': '',
            'network_id': 'cdf1eb6d-9b17-424a-a054-778f3d3a5490',
            'operating_status': 'ONLINE',
            'pools': [
                {'id': '2dbca6cd-30d8-4013-9c9a-df0850fabf52'}],
            'provider': 'f5networks',
            'provisioning_status': 'ACTIVE',
            'tenant_id': 'd9ed216f67f04a84bf8fd97c155855cd',
            'vip_address': '172.16.101.3',
            'vip_port': {'admin_state_up': True,
                          'allowed_address_pairs': [],
                          'binding:host_id':
                              'host-164.int.lineratesystems.com:16ea1e',
                          'binding:profile': {},
                          'binding:vif_details': {},
                          'binding:vif_type': 'binding_failed',
                          'binding:vnic_type': 'normal',
                          'created_at': '2016-10-24T21:17:30',
                          'description': None,
                          'device_id': '0bd0b8ff-1c51-5061-b0c4',
                          'device_owner': 'F5:lbaasv2',
                          'dns_name': None,
                          'extra_dhcp_opts': [],
                          'fixed_ips': [
                              {'ip_address': '172.16.101.3',
                               'subnet_id': '81f42a8a-fc98-4281-8de4'}],
                          'id': '38a13e5c-6863-4537-80a3',
                          'mac_address': 'fa:16:3e:94:65:0c',
                          'name': 'loadbalancer-d5a0396e-e862',
                          'network_id': 'cdf1eb6d-9b17-424a',
                          'security_groups': ['df88afdb-2bc6-4621'],
                          'status': 'DOWN',
                          'tenant_id': 'd9ed216f67f04a84bf8fd',
                          'updated_at': '2016-10-24T21:17:31'},
            'vip_port_id': '38a13e5c-6863-4537-80a3-c788d5f0c9ce',
            'vip_subnet_id': '81f42a8a-fc98-4281-8de4-2b946e931457',
            'vxlan_vteps': []},
        'members': [{'address': '10.2.2.3',
                      'admin_state_up': True,
                      'id': '1e7bfa17-a38f-4728-a3a7-aad85da69712',
                      'name': '',
                      'network_id': 'cdf1eb6d-9b17-424a-a054-778f3d3a5490',
                      'operating_status': 'ONLINE',
                      'pool_id': '2dbca6cd-30d8-4013-9c9a-df0850fabf52',
                      'protocol_port': 8080,
                      'provisioning_status': 'ACTIVE',
                      'subnet_id': '81f42a8a-fc98-4281-8de4-2b946e931457',
                      'tenant_id': 'd9ed216f67f04a84bf8fd97c155855cd',
                      'port': 'port',
                      'weight': 1},
                     {'address': '10.2.2.4',
        ...
        'pools': [{'admin_state_up': True,
                    'description': '',
                    'healthmonitor_id': '70fed03a-efc4-460a-8a21',
                    'id': '2dbca6cd-30d8-4013-9c9a-df0850fabf52',
                    'l7_policies': [],
                    'lb_algorithm': 'ROUND_ROBIN',
                    'listeners':[
                        {'id': '5108c2fe-29bd-4e5b-94de-99034c561a15'}],
                    'loadbalancer_id': 'd5a0396e-e862-4cbf-8eb9-25c7fbc4d59',
                    'name': '',
                    'operating_status': 'ONLINE',
                    'protocol': 'HTTP',
                    'provisioning_status': 'ACTIVE',
        ...
        'l7policies': [
            {
                ...
                'admin_state_up': True,
                'description': '',
                'id': '23eea01d-5151-44fd-9ceb-6356bbb1ebb7',
                'listener_id': '7ddad6cc-887d-49aa-b970-5820471dc6e5',
                'name': '',
                'position': 2,
                'provisioning_status': 'PENDING_CREATE',
                'redirect_pool_id': None,
                'redirect_url': None,
                'rules': [],
                'tenant_id': '5197d6a284044c72b63f2fe6ae6edc21'},
            {
                'action': 'REJECT',
                'admin_state_up': True,
                'description': '',
                'id': '8935a899-706d-46d6-8376-51f013431533',
                'listener_id': '7ddad6cc-887d-49aa-b970-5820471dc6e5',
                'name': '',
                'position': 1,
                'provisioning_status': 'ACTIVE',
        ...
        'listeners': [
            {
                ...
                'default_tls_container_id': None,
                'description': '',
                'id': '7ddad6cc-887d-49aa-b970-5820471dc6e5',
                'l7_policies': [
                    {
                        'id': '8935a899-706d-46d6-8376-51f013431533'},
                    {
                        'id': '23eea01d-5151-44fd-9ceb-6356bbb1ebb7'}],
                'loadbalancer_id': 'd5a0396e-e862-4cbf-8eb9-25c7fbc4d593',
                'name': 'vs1',
                'operating_status': 'ONLINE',
                'protocol': 'HTTP',
                'protocol_port': 80,
                'provisioning_status': 'ACTIVE',
                'snat_pool_name': 'Project_5197d6a284044c72b63f2fe6ae6edc21',
                'sni_containers': [],
                'tenant_id': '5197d6a284044c72b63f2fe6ae6edc21',
                'use_snat': True}],
        'members': [],
        ...
        'l7policies': [
            {
                ...
                'redirect_pool_id': None,
                'redirect_url': None,
                'rules': [{'id': '40e06ae9-3297-435d-be23-f3f6ff465e22'}],
                'tenant_id': '5197d6a284044c72b63f2fe6ae6edc21'},
            {
                'action': 'REJECT',
                'admin_state_up': True,
        ...
        'l7policy_rules': [
            {
                'admin_state_up': True,
                'compare_type': 'EQUAL_TO',
                'id': '40e06ae9-3297-435d-be23-f3f6ff465e22',
                'invert': False,
                'key': None,
                'policies': [
                    {'id': '23eea01d-5151-44fd-9ceb-6356bbb1ebb7'}],
                'policy_id': '23eea01d-5151-44fd-9ceb-6356bbb1ebb7',
                'provisioning_status': 'PENDING_CREATE',
                'tenant_id': '5197d6a284044c72b63f2fe6ae6edc21',
                'type': 'FILE_TYPE',
                'value': 'txt'}],
