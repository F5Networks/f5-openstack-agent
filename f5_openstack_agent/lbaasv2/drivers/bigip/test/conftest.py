...
class TestingWithServiceConstructor(object):
    ...
    def service_with_subnet(cls, new_id, service_with_network):
        network_id = list(service_with_network['networks'].keys())[0]
    ...
    def service_with_loadbalancer(cls, new_id, service_with_subnet):
        network_id = list(service_with_subnet['networks'].keys())[0]
        subnet_id = list(service_with_subnet['subnets'].keys())[0]
...
def pool_member_service():
    return {
        'loadbalancer': {
            'admin_state_up': True,
            'description': '',
            'gre_vteps': ['201.0.162.1', '201.0.160.1', '201.0.165.1'],
            'id': 'd5a0396e-e862-4cbf-8eb9-25c7fbc4d593',
            'listeners': [{'id': 'e3af03f4-d3df-4c9b-b3dd-8002f133d5bf'}],
            'name': '',
            'network_id': 'cdf1eb6d-9b17-424a-a054-778f3d3a5490',
            'operating_status': 'ONLINE',
            'pools': [{'id': '2dbca6cd-30d8-4013-9c9a-df0850fabf52'}],
            'provider': 'f5networks',
            ...
            'vip_port': {
                ...
                'binding:host_id': 'host-164.int.lineratesystems.com:16ea1e',
                'binding:profile': {},
                'binding:vif_details': {},
