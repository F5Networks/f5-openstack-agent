...
crudini --set $tempest icontrol icontrol_hostname $ICONTROL_HOSTNAME
crudini --set $tempest icontrol icontrol_username admin
crudini --set $tempest icontrol icontrol_password admin
pip install /root/f5-openstack-agent
