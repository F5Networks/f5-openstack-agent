...
from f5_lbaasv2_agent_tempest_plugin.tests.api import base
...
class LoadBalancersTestJSON(base.BaseAdminTestCase):
    ...
    def test_create_load_balancer_with_tenant_id_field_for_admin(self):
        ...
        print self.load_balancers_client.list_load_balancers()

        self._wait_for_load_balancer_status(load_balancer['id'])
        self.assertTrue(self.bigip_client.verify_folders(folder_name))
