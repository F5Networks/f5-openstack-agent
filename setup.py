...
setuptools.setup(
    ...
    data_files=[('/etc/neutron/services/f5', ['etc/neutron/services/f5/f5-openstack-agent.ini', 'etc/neutron/services/f5/f5-extended-profile.json']),
    ...
    entry_points={
        'console_scripts': [
            ...
            'check-data = f5_openstack_agent.lbaasv2.drivers.bigip.check_data:main'
        ]
    },
