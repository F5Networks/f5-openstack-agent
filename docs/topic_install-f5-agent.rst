...
.. code-block:: text
    ...
    $ sudo pip install git+https://github.com/F5Networks/f5-openstack-agent@v9.3.0.b1
...
.. code-block:: bash
    ...
    $ curl -L -O https://github.com/F5Networks/f5-openstack-agent/releases/download/v9.3.0.b1/python-f5-openstack-agent_9.3.0.b1-1_1404_all.deb
    $ sudo dpkg –i python-f5-openstack-agent_9.3.0.b1-1_1404_all.deb
...
.. code-block:: bash
    ...
    $ curl -L -O https://github.com/F5Networks/f5-openstack-agent/releases/download/v9.3.0.b1/f5-openstack-agent-9.3.0.b1-1.el7.noarch.rpm
    $ sudo rpm –ivh f5-openstack-agent-9.3.0.b1-1.el7.noarch.rpm
