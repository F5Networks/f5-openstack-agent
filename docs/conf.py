# -*- coding: utf-8 -*-
#
# F5 OpenStack Agent documentation build configuration file, created by
...
html_title = u'F5 OpenStack Agent'
...
htmlhelp_basename = 'F5OpenStackAgentdoc'
...
latex_documents = [
    (master_doc, 'F5OpenStackAgent.tex', u'F5 OpenStack Agent Documentation',
...
man_pages = [
    (master_doc, 'f5openstackagent', u'F5 OpenStack Agent Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5OpenStackAgent', u'F5 OpenStack Agent Documentation',
     author, 'F5OpenStackAgent', 'One line description of project.',
     'Miscellaneous'),
]
